...
-->
	...
	<div class="milestone-background-img">
		...
		<div class="container milestone-content">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div>
						<h3 class="milestone-value">1059+</h3>
						<h4 class="milestone-description">MONTHLY SUPPORT REQUESTS</h4>
						<p class="milestone-info">The amount of requests received by our helpdesk in the past month</p>
					</div>
				</div>

				<div class="col-md-3">
					<div>
						<h3 class="milestone-value">98%</h3>
						<h4 class="milestone-description">REQUESTS CLOSED IN UNDER 1 HOUR</h4>
						<p class="milestone-info">97% of our requests are closed within one hour of support being requested – we are very proud of this statistic which creates business benefits for our busy clients.</p>
					</div>
				</div>
	...
	<div class="container partnerships-content">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<img class="partnerships-img" src="<?php echo get_theme_file_uri('./images/partners/aws.png'); ?>">
			</div>

			<div class="col-md-3">
				<img class="partnerships-img" src="<?php echo get_theme_file_uri('./images/partners/microsoft.png'); ?>">
			</div>

			<div class="col-md-3">
				<img class="partnerships-img" src="<?php echo get_theme_file_uri('./images/partners/google.png'); ?>">
			</div>

			<div class="col-md-3">
				<img class="partnerships-img" src="<?php echo get_theme_file_uri('./images/partners/apple.png'); ?>">
			</div>
